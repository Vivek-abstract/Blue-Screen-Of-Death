...
void TranslateY_ScaleX(int x, int y, int ty, int sx) {
...
void main() {
	...
	for(i = 100; i <= 200; i++) {
		TranslateY_ScaleX(i,100,150,2);
		TranslateY_ScaleX(200,i,150,2);
		TranslateY_ScaleX(i,200,150,2);
		TranslateY_ScaleX(100,i,150,2);
	}
