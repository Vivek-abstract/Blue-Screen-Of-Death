...
void TranslateY_ScaleY(int x, int y, int ty, int sy) {
...
void main() {
	...
	for(i = 100; i <= 200; i++) {
		TranslateY_ScaleY(i,100,5,2);
		TranslateY_ScaleY(200,i,5,2);
		TranslateY_ScaleY(i,200,5,2);
		TranslateY_ScaleY(100,i,5,2);
	}
